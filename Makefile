...
#     NAME => q[Blog]
#     NO_META => q[1]
#     PREREQ_PM => { Test::More=>q[0.88], Catalyst::Plugin::Static::Simple=>q[0], Catalyst::Plugin::StackTrace=>q[0], Catalyst::Plugin::Session::State::Cookie=>q[0], MooseX::NonMoose=>q[0], namespace::autoclean=>q[0], Config::General=>q[0], DBIx::Class::Schema::Loader module=>q[0], ExtUtils::MakeMaker=>q[6.36], Catalyst::Runtime=>q[5.90090], Catalyst::Helper::View::TT=>q[0], Catalyst::Plugin::Authentication=>q[0], DBIx::Class::Schema::Loader=>q[0], Catalyst::Plugin::Session=>q[0], Catalyst::Plugin::ConfigLoader=>q[0], Catalyst::Model::DBIC::Schema=>q[0], Moose=>q[0], Catalyst::Plugin::Session::Store::File=>q[0], Catalyst::Action::RenderView=>q[0], DBD::mysql=>q[0] }
#     TEST_REQUIRES => {  }
#     VERSION => q[0.01]
...
MAN3PODS = lib/Blog.pm \
	...
	lib/Blog/Schema/Result/Article.pm \
...
PM_TO_BLIB = lib/Blog/Schema/Result/User.pm \
	blib/lib/Blog/Schema/Result/User.pm \
	lib/Blog/Schema/Result/Article.pm \
	blib/lib/Blog/Schema/Result/Article.pm \
	lib/Blog/View/HTML.pm \
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=$(MAN3EXT) --perm_rw=$(PERM_RW) \
	  ...
	  lib/Blog/Schema/Result/Article.pm $(INST_MAN3DIR)/Blog::Schema::Result::Article.$(MAN3EXT) \
...
pure_all :: $(INST_SCRIPT)/blog_fastcgi.pl $(INST_SCRIPT)/blog_test.pl $(INST_SCRIPT)/blog_create.pl $(INST_SCRIPT)/blog_server.pl $(INST_SCRIPT)/blog_cgi.pl
	$(NOECHO) $(NOOP)

realclean ::
	$(RM_F) \
	  $(INST_SCRIPT)/blog_fastcgi.pl $(INST_SCRIPT)/blog_test.pl \
	  $(INST_SCRIPT)/blog_create.pl $(INST_SCRIPT)/blog_server.pl \
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <AUTHOR>rania fathy,,,</AUTHOR>' >> $(DISTNAME).ppd
	...
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="Catalyst::Runtime" VERSION="5.9009" />' >> $(DISTNAME).ppd
	...
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="DBIx::Class::Schema::Loader module" />' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  ...
	  lib/Blog/Schema/Result/Article.pm blib/lib/Blog/Schema/Result/Article.pm \
...
installdeps ::
	$(PERL) Makefile.PL --config= --installdeps=DBIx::Class::Schema::Loader module,0,Catalyst::Plugin::Authentication,0,Catalyst::Plugin::Session,0,Catalyst::Plugin::Session::Store::File,0,Catalyst::Plugin::Session::State::Cookie,0

installdeps_notest ::
	$(PERL) Makefile.PL --config=notest,1 --installdeps=DBIx::Class::Schema::Loader module,0,Catalyst::Plugin::Authentication,0,Catalyst::Plugin::Session,0,Catalyst::Plugin::Session::Store::File,0,Catalyst::Plugin::Session::State::Cookie,0

upgradedeps ::
	$(PERL) Makefile.PL --config= --upgradedeps=DBIx::Class::Schema::Loader module,0,Catalyst::Plugin::Authentication,0,Catalyst::Plugin::Session,0,Catalyst::Plugin::Session::Store::File,0,Catalyst::Plugin::Session::State::Cookie,0,Test::More,0.88,Catalyst::Plugin::StackTrace,0,Catalyst::Helper::View::TT,0,DBD::mysql,0,Catalyst::Model::DBIC::Schema,0,DBIx::Class::Schema::Loader,0,MooseX::NonMoose,0,Catalyst::Runtime,5.90090,Catalyst::Plugin::ConfigLoader,0,Catalyst::Plugin::Static::Simple,0,Catalyst::Action::RenderView,0,Moose,0,namespace::autoclean,0,Config::General,0

upgradedeps_notest ::
	$(PERL) Makefile.PL --config=notest,1 --upgradedeps=DBIx::Class::Schema::Loader module,0,Catalyst::Plugin::Authentication,0,Catalyst::Plugin::Session,0,Catalyst::Plugin::Session::Store::File,0,Catalyst::Plugin::Session::State::Cookie,0,Test::More,0.88,Catalyst::Plugin::StackTrace,0,Catalyst::Helper::View::TT,0,DBD::mysql,0,Catalyst::Model::DBIC::Schema,0,DBIx::Class::Schema::Loader,0,MooseX::NonMoose,0,Catalyst::Runtime,5.90090,Catalyst::Plugin::ConfigLoader,0,Catalyst::Plugin::Static::Simple,0,Catalyst::Action::RenderView,0,Moose,0,namespace::autoclean,0,Config::General,0

listdeps ::
	@$(PERL) -le "print for @ARGV" DBIx::Class::Schema::Loader module Catalyst::Plugin::Authentication Catalyst::Plugin::Session Catalyst::Plugin::Session::Store::File Catalyst::Plugin::Session::State::Cookie

listalldeps ::
	@$(PERL) -le "print for @ARGV" DBIx::Class::Schema::Loader module Catalyst::Plugin::Authentication Catalyst::Plugin::Session Catalyst::Plugin::Session::Store::File Catalyst::Plugin::Session::State::Cookie Test::More Catalyst::Plugin::StackTrace Catalyst::Helper::View::TT DBD::mysql Catalyst::Model::DBIC::Schema DBIx::Class::Schema::Loader MooseX::NonMoose Catalyst::Runtime Catalyst::Plugin::ConfigLoader Catalyst::Plugin::Static::Simple Catalyst::Action::RenderView Moose namespace::autoclean Config::General
